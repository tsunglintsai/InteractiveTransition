...
#define kPMTransitionDuration 0.5
...
//    [UIView animateWithDuration:kPMTransitionDuration delay:0 usingSpringWithDamping:0.9 initialSpringVelocity:0.9 options:UIViewAnimationOptionBeginFromCurrentState animations:^{
